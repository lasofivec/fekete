...
# Algorithm for any degree box splines
def boxspline(x,y,n):
    x = -abs(x); y = abs(y);
...
# Optimized algorith for degree 2 box splines
...
pl.scatter(X,Y,marker='.')
pl.axis('equal')
pl.title("SCALED MESH : chi1 with arbitrary degrre and general hex mesh")
pl.show(block=True)
